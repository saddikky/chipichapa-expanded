...
<div class="d-flex flex-column min-vh-100">
    <!-- NAVBAR 10.33-->
    <nav class="navbar navbar-expand-lg bg-body-tertiary adm-custom-navbar">
    <div class="container-fluid">
        ...
        <ul class="navbar-nav ms-auto navbar-nav-right">
            ...
            <ul class="dropdown-menu dropdown-menu-end">
                ...
                <li>
                    <a class="dropdown-item" href="{{ route('employee.list') }}">Employee List</a>
                </li>
                <li>
                    <a class="dropdown-item" href="{{ route('employee.show') }}">Edit Employee</a>
                </li>
                <li>
                    <a class="dropdown-item" href="{{ route('admin.appt.list') }}">Appointment List</a>
                </li>
                <li>
